@php
    ...
    $icons = [
        ...
        'palette' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M7 21a4 4 0 01-4-4V5a2 2 0 012-2h4a2 2 0 012 2v12a4 4 0 01-4 4zm0 0h12a2 2 0 002-2v-4a2 2 0 00-2-2h-2.343M11 7.343l1.657-1.657a2 2 0 012.828 0l2.829 2.829a2 2 0 010 2.828l-8.486 8.485" />',
        ...
        'portal' => '<path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />',
    ...
    $d = $icons[$iconName] ?? $icons['building'];
    $svgClass = $class ?? 'h-5 w-5';
@endphp
<svg class="{{ $svgClass }}" fill="none" viewBox="0 0 24 24" stroke="currentColor" aria-hidden="true">{!! $d !!}</svg>
