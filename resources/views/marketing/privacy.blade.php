...
@section('meta_description', __('Marketing privacy meta'))
...
@section('content')
    @include('marketing.partials.hero', [
        ...
        'lead' => __('Marketing privacy lead'),
    ])
    ...
    <section class="mx-auto max-w-4xl px-6 py-16 sm:px-10 lg:px-12">
        <div class="space-y-8">
            <div class="rounded-2xl border border-slate-200/90 bg-white p-8 shadow-sm ring-1 ring-slate-900/[0.03]">
                <h2 class="text-xl font-semibold text-slate-900">{{ __('Marketing privacy s1 title') }}</h2>
                <p class="mt-3 text-slate-600 leading-relaxed">{{ __('Marketing privacy s1 body') }}</p>
            </div>
            <div class="rounded-2xl border border-slate-200/90 bg-white p-8 shadow-sm ring-1 ring-slate-900/[0.03]">
                <h2 class="text-xl font-semibold text-slate-900">{{ __('Marketing privacy s2 title') }}</h2>
                <p class="mt-3 text-slate-600 leading-relaxed">{{ __('Marketing privacy s2 body') }}</p>
            </div>
            <div class="rounded-2xl border border-slate-200/90 bg-white p-8 shadow-sm ring-1 ring-slate-900/[0.03]">
                <h2 class="text-xl font-semibold text-slate-900">{{ __('Marketing privacy s3 title') }}</h2>
                <p class="mt-3 text-slate-600 leading-relaxed">{{ __('Marketing privacy s3 body') }}</p>
            </div>
