        ...
        <div class="flex items-start gap-3">
            ...
            <div class="min-w-0 flex-1">
                <div class="flex flex-wrap items-center justify-between gap-2">
                    ...
                    <span class="text-xs font-medium text-violet-700 dark:text-violet-300">{{ __('invoice_ai_credits_cost') }}</span>
                </div>
                <p class="mt-1 text-sm text-slate-600 dark:text-slate-400">{{ __('invoice_ai_panel_intro') }}</p>
                <x-ai-voice-wrap target-id="invoice_ai_brief" submit-button-id="invoice_ai_generate_btn" class="mt-4">
                    <textarea
                        id="invoice_ai_brief"
                        x-model="aiBrief"
                        rows="3"
                        ...
                        placeholder="{{ __('invoice_ai_brief_placeholder') }}"
                    ></textarea>
                </x-ai-voice-wrap>
                ...
                @include('documents.partials.line-items-document-scan', ['scanCreditsKey' => 'invoice_ai_scan_credits_cost'])
            </div>
        </div>
    </section>
@endif
